...
@Inclubating
final class DefaultPooledMemoryAllocator implements MemoryAllocator {
  ...
  DefaultPooledMemoryAllocator(MemoryAllocator memoryAllocator, int maxMemoryCapacity) {
    this(
  ...
  DefaultPooledMemoryAllocator(int poolSize, int maxPoolSize, int maxMemoryCapacity) {
