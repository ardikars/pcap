...
/**
 * Abstraction over an address space of readable and writable bytes, also can used to
 * allocate/reallocate/deallocate buffer's.
 *
 * <p>
 *
...
public interface MemoryAccessor {
   ...
   * size of previously allocated memory using this funtions.
   *
  ...
  /**
   * Copies memory from given source address and source index to given destination address as given
   * destination index and size.
   *
