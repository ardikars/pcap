...
public final class Strings {
  ...
  /**
   * Default to string builer.
   *
   * @param obj data.
   * @return returns default to string builder.
   * @since 1.0.0
   */
  ...
  /**
   * Json to string builder.
   *
   * @return returns json to string builder.
   * @since 1.0.0
   */
   ...
   * @param quoteString {@code true} if quoted string. {@code false} othersize.
   * @return returns to string builder.
   * @since 1.0.0
   */
