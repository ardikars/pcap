...
public class NamedMultiKeyTest {
    ...
    public void found() {
        ...
        Assertions.assertEquals(IcmpTypeAndCode.NO_ROUTE_TO_DESTINATION.getValue(), icmpTypeAndCode.getValue());
    }
    ...
    public void registerNewCode() {
        ...
        Assertions.assertEquals(COMMUNICATION_WITH_DESTINATION_ADMINIS_TRATIVELY_PROHIBITED, communicationWithxxx.getValue());
    }
