...
public class Icmp6ParameterProblem extends Icmp.IcmpTypeAndCode {
  ...
  static {
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(ERRORNEOUS_HEADER_FIELD_ENCOUTERED);
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(UNRECOGNIZED_NEXT_HEADER_TYPE_ENCOUNTERED);
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(UNRECOGNIZED_IPV6_OPTION_ENCOUNTERED);
  }
}
