...
public class Icmp6NodeInformationResponse extends Icmp.IcmpTypeAndCode {
  ...
  public static final Icmp6NodeInformationResponse QTYPE_OF_THE_QUERY_IS_UNKNOWN_TO_THE_RESPONDER =
      new Icmp6NodeInformationResponse(
          (byte) 2, "The Qtype of the Query is unknown to the Responder");
  ...
  static {
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(SUCCESSFULL_REPLY);
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(RESPONDER_REFUSES_TO_SUPPLY_THE_ASWER);
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(QTYPE_OF_THE_QUERY_IS_UNKNOWN_TO_THE_RESPONDER);
  }
}
