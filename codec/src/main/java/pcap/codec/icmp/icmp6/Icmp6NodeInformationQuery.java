...
public class Icmp6NodeInformationQuery extends Icmp.IcmpTypeAndCode {
  ...
  public static final Icmp6NodeInformationQuery DATA_FIELD_CONTAIONS_NAME =
      new Icmp6NodeInformationQuery(
          (byte) 1, "Data field contains a name which is the Subject of this Query");
  ...
  static {
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(DATA_FIELD_CONTAINS_IPV6_ADDRESS);
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(DATA_FIELD_CONTAIONS_NAME);
    Icmp.IcmpTypeAndCode.ICMP6_REGISTRY.add(DATA_FIELD_CONTAINS_IPV4_ADDRESS);
  }
}
