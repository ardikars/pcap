...
public class Icmp4DestinationUnreachable extends Icmp.IcmpTypeAndCode {
  ...
  static {
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(DESTINATION_NETWORK_UNREACHABLE);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(DESTINATION_HOST_UNREACHABLE);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(DESTINATION_PROTOCOL_UNREACHABLE);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(DESTINATION_PORT_UNREACHABLE);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(FRAGMENTATION_REQUIRED);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(SOURCE_ROUTE_FAILED);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(DESTINATION_NETWORK_UNKNOWN);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(DESTINATION_HOST_UNKOWN);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(SOURCE_HOST_ISOLATED);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(NETWORK_ADMINISTRATIVELY_PROHIBITED);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(HOST_ADMINISTRATIVELY_PROHIBITED);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(NETWORK_UNREACHABLE_FOR_TOS);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(HOST_UNREACHABLE_FOR_TOS);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(COMMUNICATION_ADMINISTRATIVELY_PROHIBITED);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(HOST_PRECEDENCE_VIOLATION);
    Icmp.IcmpTypeAndCode.ICMP4_REGISTRY.add(PRECEDENCE_CUTOFF_IN_EFFECT);
  }
}
