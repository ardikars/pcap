...
/**
 * Linux pcap api mapping.
 *
 * @author <a href="mailto:contact@ardikars.com">Ardika Rommy Sanjaya</a>
 */
@NativeHeader(resolutionContext = {linux_structs.pcap_pkthdr.class, linux_structs.timeval.class})
public interface linux_pcap_header {
  ...
  int pcap_dispatch(
      Pointer<pcap_header.pcap> p,
      int cnt,
      Callback<linux_callback.pcap_handler> usr,
      Pointer<Byte> pp);

  @NativeFunction("(u64:${pcap}u64:u64:${pcap_pkthdr}u64:u64:u8)i32")
  int pcap_next_ex(
      Pointer<pcap_header.pcap> p,
      Pointer<? extends Pointer<linux_structs.pcap_pkthdr>> pkthdr_p,
      Pointer<? extends Pointer<Byte>> buf);

  @NativeFunction("(u64:u8u64:${pcap_pkthdr}u64:u8)v")
  void pcap_dump(Pointer<Byte> p, Pointer<linux_structs.pcap_pkthdr> pkthdr_p, Pointer<Byte> buf);
}
